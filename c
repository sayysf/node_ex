...
connect= UdJsH53q-ITWN0sKAAAB
2
connect= 4GeoFDEvJRM01WSQAAAD
3
connect= OpaQW8gyfRPDT6aHAAAF
...
<ref *1> Socket {
  ...
  nsp: <ref *2> Namespace {
    ...
    _maxListeners: undefined,
    sockets: Map(3) {
      'UdJsH53q-ITWN0sKAAAB' => [Circular *1],
      '4GeoFDEvJRM01WSQAAAD' => [Socket],
      'OpaQW8gyfRPDT6aHAAAF' => [Socket]
    },
    _fns: [],
    _ids: 0,
    server: Server {
  ...
  client: Client {
    sockets: Map(1) { 'UdJsH53q-ITWN0sKAAAB' => [Circular *1] },
  ...
  adapter: <ref *4> Adapter {
    ...
    rooms: Map(3) {
      'UdJsH53q-ITWN0sKAAAB' => [Set],
      '4GeoFDEvJRM01WSQAAAD' => [Set],
      'OpaQW8gyfRPDT6aHAAAF' => [Set]
    },
    sids: Map(3) {
      'UdJsH53q-ITWN0sKAAAB' => [Set],
      '4GeoFDEvJRM01WSQAAAD' => [Set],
  ...
  handshake: {
    ...
    time: 'Sat Aug 20 2022 16:34:01 GMT+0300 (GMT+03:00)',
    address: '::ffff:127.0.0.1',
    xdomain: false,
    secure: false,
    issued: 1661002441477,
    url: '/socket.io/?EIO=4&transport=polling&t=OAxTUBC',
